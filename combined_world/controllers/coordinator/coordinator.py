...
#         # --------------------------------------------------
#         # NEW INTELLIGENT ORCHESTRATION STATE
#         # --------------------------------------------------
...
#             node = self.robot.getFromDef(
#                 CAN_BELT_DEF[k]
#             )

#             self.can_belt_speed.append(
#                 node.getField("speed")
#                 if node else None
#             )

#         scara_node = self.robot.getFromDef(
#             "SCARA_BELT"
#         )

#         self.scara_belt_speed = (
#             scara_node.getField("speed")
#             if scara_node else None
#         )

#         # SCARA nested motor fix
...
#                 self.scara_motor_vel = (
#                     motor.getField("velocity")
#                 )
...
#                         self.can_belt_speed[k].setSFFloat(
#                             CAN_BELT_NOMINAL[k]
#                         )

#                 self.log_and_ui(
#                     f"{LOG_PREFIX}"
#                     f"can conveyors STARTED\n"
#                 )
...
#                 self.log_and_ui(
#                     f"{LOG_PREFIX}"
#                     f"can conveyors STOPPED\n"
#                 )

#             elif line == "CONVEYOR_START fruit":

#                 self.conveyor_set_fruit(
#                     SCARA_BELT_NOMINAL
#                 )

#                 self.log_and_ui(
#                     f"{LOG_PREFIX}"
#                     f"fruit conveyor STARTED\n"
#                 )
...
#                 self.log_and_ui(
#                     f"{LOG_PREFIX}"
#                     f"Production mode set to "
#                     f"{self.production_mode}\n"
#                 )
...
#             elif line.startswith("ENABLE_ARM "):
...
#             elif line.startswith("DISABLE_ARM "):
...
#             elif line == "AUTO_BALANCE ON":

#                 self.auto_balance = True

#                 self.log_and_ui(
#                     f"{LOG_PREFIX}"
#                     f"Auto balancing ENABLED\n"
#                 )

#             elif line == "AUTO_BALANCE OFF":

#                 self.auto_balance = False

#                 self.log_and_ui(
#                     f"{LOG_PREFIX}"
#                     f"Auto balancing DISABLED\n"
#                 )
...
#             self.scara_fruit_type = (
#                 random.randint(0, 1)
#             )

#             self.send_scara_cmd(
#                 f"SCARA_SET_FRUIT "
#                 f"{self.scara_fruit_type}"
#             )
...
#                 busy_count = sum(
#                     1 for s in self.arms_state
#                     if s != WAITING
#                 )

#                 if busy_count >= 2:

#                     if not self.arm_enabled[2]:

#                         self.arm_enabled[2] = True

#                         self.log_and_ui(
#                             f"{LOG_PREFIX}"
#                             f"Auto balance activated "
#                             f"UR10e\n"
#                         )

#                 elif busy_count == 0:

#                     if self.arm_enabled[2]:

#                         self.arm_enabled[2] = False

#                         self.log_and_ui(
#                             f"{LOG_PREFIX}"
#                             f"UR10e moved to standby\n"
#                         )
...
#             if self.production_mode == "balanced":

#                 allowed_arms = [0, 1, 2]

#             elif self.production_mode == "prioritize_fruit":

#                 allowed_arms = []

#             elif self.production_mode == "maximize_cans":

#                 allowed_arms = [0, 1, 2]

#             elif self.production_mode == "low_power":

#                 allowed_arms = [0]

#             elif self.production_mode == "high_capacity":
...
#             # --------------------------------------------------
#             # UR ARM ORCHESTRATION
#             # --------------------------------------------------

#             for i in range(3):

#                 if i not in allowed_arms:
#                     continue

#                 if not self.arm_enabled[i]:
#                     continue
...
#             if (
#                 self.scara_stride_ctr
#                 % stride == 0
#             ):

#                 self.scara_coordinator_step()

#             sim_wall_sleep_after_step(
#                 self.timestep
#             )
...
class Coordinator:
    ...
    def __init__(self):
        ...
        # --------------------------------------------------
        # Conveyor runtime state
        # --------------------------------------------------

        self.can_conveyor_running = False

        self.fruit_conveyor_running = False
    ...
    def process_line(self, sock, line):
        ...
        if c.role == ROLE_UI:
            ...
            # --------------------------------------------------
                ...
                self.can_conveyor_running = True
            ...
            # --------------------------------------------------
                ...
                self.fruit_conveyor_running = True
    ...
    def run(self):
        ...
        while self.robot.step(self.timestep) != -1:
            ...
            for i in range(3):
                ...
                if not self.can_conveyor_running:
                    continue
            ...
            if (
                self.fruit_conveyor_running
                and
                self.scara_stride_ctr % stride == 0
            ):
